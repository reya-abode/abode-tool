...
export const METRIC_SPECS: MetricSpec[] = [
  ...
  { key: "fteConversionRatePct", label: "Intern to FTE conversion rate", unit: "percent", aliases: ["intern to fte conversion rate", "employee to fte conversion rate", "fte conversion rate", "intern conversion rate", "conversion to full time", "conversion rate", "conversion"] },
